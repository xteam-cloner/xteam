...
if run_as_module:
    ...
    ULTROID_CLIENTS[2] = create_additional_client(getattr(Var, 'SESSION_2', None), 2)
    ULTROID_CLIENTS[3] = create_additional_client(getattr(Var, 'SESSION_3', None), 3)
    ULTROID_CLIENTS[4] = create_additional_client(getattr(Var, 'SESSION_4', None), 4)
    ULTROID_CLIENTS[5] = create_additional_client(getattr(Var, 'SESSION_5', None), 5)
